...
${OBJECTDIR}/JeffryLarin_13\ Ed_\ Chap\ 3_Problem\ 12_Celsius\ to\ Fahrenheit.o: JeffryLarin_13\ Ed_\ Chap\ 3_Problem\ 12_Celsius\ to\ Fahrenheit.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/JeffryLarin_13\ Ed_\ Chap\ 3_Problem\ 12_Celsius\ to\ Fahrenheit.o JeffryLarin_13\ Ed_\ Chap\ 3_Problem\ 12_Celsius\ to\ Fahrenheit.cpp

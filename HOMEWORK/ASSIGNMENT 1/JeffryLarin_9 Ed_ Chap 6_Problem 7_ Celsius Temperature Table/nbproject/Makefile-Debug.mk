...
${OBJECTDIR}/JeffryLarin_9\ Ed_\ Chap\ 6_Problem\ 7_\ Celsius\ Temperature\ Table.o: JeffryLarin_9\ Ed_\ Chap\ 6_Problem\ 7_\ Celsius\ Temperature\ Table.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/JeffryLarin_9\ Ed_\ Chap\ 6_Problem\ 7_\ Celsius\ Temperature\ Table.o JeffryLarin_9\ Ed_\ Chap\ 6_Problem\ 7_\ Celsius\ Temperature\ Table.cpp
